...
export const METRICS_DATA: MetricData[] = [
  {
    ...
    shortDescription: 'Una métrica fundamental que conecta el comportamiento del usuario con el crecimiento y el impacto directo en los resultados del negocio.',
  ...
  },
  {
    ...
    acronym: 'SUS',
    shortDescription: 'Un estándar de la industria para cuantificar la usabilidad percibida de sistemas complejos mediante un cuestionario rápido y confiable.',
  ...
  },
  {
    ...
    shortDescription: 'Mide la eficiencia crítica de los flujos de trabajo determinando el porcentaje de usuarios que logran finalizar sus objetivos sin abandonar.',
  ...
  },
  {
    ...
    shortDescription: 'Cuantifica la frecuencia de errores durante tareas críticas para diagnosticar problemas de fricción y confusión en la interfaz de usuario.',
  ...
  },
  {
    ...
    acronym: 'CSAT',
    shortDescription: 'Evalúa la calidad subjetiva de la experiencia del usuario inmediatamente después de interacciones clave para medir la percepción de valor.',
  ...
  },
  {
    id: 'retention-rate',
    name: 'Retention Rate',
    shortDescription: 'Indica la capacidad del producto para mantener a los usuarios comprometidos y activos a lo largo del tiempo, señal de valor sostenible.',
  ...
  },
  {
    ...
    acronym: 'NPS',
    shortDescription: 'Un indicador estratégico que mide la lealtad del cliente y su disposición a recomendar el producto, prediciendo el crecimiento orgánico.',
  ...
  },
  {
    ...
    acronym: 'CES',
    shortDescription: 'Evalúa cuánto esfuerzo percibe el usuario que debe invertir para resolver un problema o completar una acción, crucial para la lealtad.',
  ...
  },
  {
    id: 'time-on-task',
    name: 'Time on Task',
    shortDescription: 'Mide la eficiencia operativa rastreando el tiempo promedio que los usuarios necesitan para completar exitosamente flujos de trabajo específicos.',
  ...
  },
  {
    id: 'churn-rate',
    name: 'Churn Rate',
    shortDescription: 'Calcula el porcentaje de clientes que abandonan el servicio, una métrica vital para identificar insatisfacción grave o falta de valor percibido.',
  ...
  },
  {
    id: 'adoption-rate',
    name: 'Adoption Rate',
    shortDescription: 'Analiza la velocidad y profundidad con la que los usuarios integran nuevas funcionalidades en su flujo de trabajo habitual.',
  ...
  },
  {
    ...
    shortDescription: 'Una métrica avanzada que determina qué tan eficientemente navegan los usuarios comparando su ruta real contra la ruta óptima ideal.',
  ...
  },
  {
    ...
    acronym: 'SEQ',
    shortDescription: 'Diagnóstico instantáneo post-tarea que evalúa la dificultad percibida de una acción específica para identificar puntos de dolor agudos.',
